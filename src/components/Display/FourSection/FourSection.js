    ...
    return (
        <section style={{ backgroundImage: `url(${bg})`, height: '100vh', backgroundRepeat: "no-repeat", backgroundSize: "150%", backgroundPosition: "center" }}>
            <Container style={{ marginTop: "5%", marginLeft: "25%" }}>
                <h1 style={{ fontSize: "4em", letterSpacing: "-3px" }}>Looks tough<br />Because it is.</h1>
            </Container>
            <Container className="d-flex justify-content-center flex-column" style={descStyle}>
                ...
                <h4 style={subDescStyle}>49mm titanium case</h4>
                <h4 style={subDescStyle}>Water resistance 100m*</h4>
                <h4 style={subDescStyle}>Tested to MIL-STD 810H</h4>
                <h4 style={subDescStyle}>IP6X dust resistance</h4>
            </Container>
